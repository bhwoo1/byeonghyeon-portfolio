...
function ExpBlock({ data }: { data: Exp }) {
  return (
    <section className="flex flex-col min-h-[420px] border-[1px] border-transparent rounded-lg shadow-md bg-neutral-900 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer ">
