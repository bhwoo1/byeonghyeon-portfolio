    ...
    <div className="w-full lg:w-2/3 lg:p-24 lg:pb-0 p-20 flex flex-col gap-4">
      ...
      <div className="flex flex-col bg-neutral-500 rounded-3xl gap-4 text-neutral-200 p-4">
        ...
        <p>
          ...
          수도 있습니다. 소통을 통해 서로의 입장을 이해하고, 최선의 해결책을
      ...
      <div className="flex flex-col bg-neutral-500 rounded-3xl gap-4 text-neutral-200 p-4">
        ...
        <p>
          ...
          지식에 안주하지 않고, 더 나은 방향으로 나아가기 위해 항상 공부하려 합니다. 변화하는 기술 환경 속에서 빠르게 적응하기 위해 최신 트렌드와 도구들을 
          꾸준히 학습하고, 실무에 적용할 수 있는 능력을 기르기 위해 노력하고 있습니다.
        </p>
        <p>
          ...
          부족한 부분을 채우기 위해 다양한 자료와 학습 방법을 활용하여 기술적인 깊이를 더하려고 합니다. 이
